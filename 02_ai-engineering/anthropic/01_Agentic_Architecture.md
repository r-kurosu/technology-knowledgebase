...
詳細は専用ノートを参照: [07_Claude_Agent_SDK.md](07_Claude_Agent_SDK.md)

**主なトピック**: Agent/Environment/Session の 3ステップ、カスタムツール（クライアントサイド実行）、  
SSE イベントストリーム、Messages API との使い分け
